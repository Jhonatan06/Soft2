...
@WebServlet(name = "MostrarDatosCliente", urlPatterns = {"/s02-DatosCliente"})
public class ServListarDatosCliente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "SELECT * FROM clientes"; //Cuando selecciona el cliente se tiene que refrescar las dos tablas de crecimiento y metas
        PreparedStatement stmt = null;         //Por ello, seria ideal un where en el query para que te regrese la fila de ese cliente 
        Connection con = null;
        ResultSet rs = null;
